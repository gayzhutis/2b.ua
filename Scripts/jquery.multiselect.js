...
(function ($, undefined) {
    ...
    $.widget("ech.multiselect", {
        ...
        options: {
            ...
            height: 175,
            minWidth: 225,
            //Medvedev 2012-03-29: Allows to use fixed width control
            width: 0, //if specified, then minWidth is ignored and control always has precise width
            classes: '',
        ...
        update: function () {
            ...
            //medvedev: start
            //this will position drop down menu according to height of the button
            if (this.isOpen()) {
                this.close();
                this.open();
            }
